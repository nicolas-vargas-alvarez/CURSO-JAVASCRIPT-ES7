...
/* typeof – tipos de datos */

// Ejemplo 1: typeof con string
console.log(typeof "JavaScript"); // string

// Ejemplo 2: typeof con number
console.log(typeof 3.14); // number


/*null vs undefined*/

// Ejemplo 3: undefined (no asignado)
let sinValor;
console.log(typeof sinValor); // undefined

// Ejemplo 4: null (valor vacío intencional)
const vacio = null;
console.log(typeof vacio); // object (caso especial)


/*let vs const*/

// Ejemplo 5: const no permite reasignar
const edad = 18;
// edad = 20; // ❌ Error

// Ejemplo 6: let permite reasignar
let puntos = 10;
puntos = 15;
...
// Ejemplo 7: var ignora el bloque
function pruebaVar() {
    if (true) {
        var x = 100;
    }
    console.log(x); // 100 (sale del bloque)
}
pruebaVar();
...
// Ejemplo 8: coerción implícita
console.log("10" + 5); // "105"


/* Conversión explícita*/

// Ejemplo 9: conversión manual
console.log(Number("20") + 5); // 25
